========================================================================
    WIN32-ANWENDUNG : CreateDirect3DWindow.cpp-Projektübersicht
========================================================================

Der Anwendungs-Assistent hat die CreateDirect3DWindow.cpp-Anwendung erstellt.  
Diese Datei enthält eine Übersicht des Inhalts der Dateien der
 CreateDirect3DWindow.cpp-Anwendung.


CreateDirect3DWindow.cpp.vcproj
...
CreateDirect3DWindowcpp.ico
    Dies ist eine Symboldatei, die als Anwendungssymbol (32x32) verwendet wird.
    Das Symbol wird von der Hauptressourcendatei CreateDirect3DWindow.cpp.rc einbezogen.
...
small.ico
    ...
    CreateDirect3DWindow.cpp.rc einbezogen.
...
StdAfx.h, StdAfx.cpp
    ...
    mit der Bezeichnung CreateDirect3DWindow.cpp.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj erstellt.
