========================================================================
    WIN32-ANWENDUNG: xBall-Projektübersicht
========================================================================

Diese xBall-Anwendung wurde vom Anwendungs-Assistenten
für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien,
aus denen Ihre xBall–Anwendung besteht.
...
xBall.ico
    ...
    Dieses Symbol ist in der Hauptressourcendatei "xBall.rc" 
    enthalten.
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen "xBall.pch" und eine 
