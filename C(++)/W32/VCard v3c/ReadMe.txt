========================================================================
    WIN32-ANWENDUNG : VCard v3c-Projektübersicht
========================================================================

Der Anwendungs-Assistent hat die VCard v3c-Anwendung erstellt.  
...
VCardv3c.ico
    ...
    Das Symbol wird von der Hauptressourcendatei VCard v3c.rc einbezogen.
...
StdAfx.h, StdAfx.cpp
    ...
    mit der Bezeichnung VCard v3c.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj erstellt.
