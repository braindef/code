========================================================================
    WIN32-ANWENDUNG: GDI01-Projektübersicht
========================================================================

Diese GDI01-Anwendung wurde vom Anwendungs-Assistenten
für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien,
aus denen Ihre GDI01–Anwendung besteht.
...
GDI01.ico
    ...
    Dieses Symbol ist in der Hauptressourcendatei "GDI01.rc" 
    enthalten.
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen "GDI01.pch" und eine 
